...
class CategoricalPdType(PdType):
    def __init__(self, ncat, r=False):
        self.ncat = ncat
        self.r=r
    def pdclass(self):
...
class MultiCategoricalPdType(PdType):
    def __init__(self, nvec, r=False):
        self.ncats = nvec
    def pdclass(self):
...
class DiagGaussianPdType(PdType):
    def __init__(self, size, r=False):
        self.size = size
        self.r=r
    def pdclass(self):
...
def make_pdtype(ac_space, r=False):
    from gym import spaces
    if isinstance(ac_space, spaces.Box):
        assert len(ac_space.shape) == 1
        return DiagGaussianPdType(ac_space.shape[0], r)
    elif isinstance(ac_space, spaces.Discrete):
        return CategoricalPdType(ac_space.n, r)
    elif isinstance(ac_space, spaces.MultiDiscrete):
        return MultiCategoricalPdType(ac_space.nvec, r)
    elif isinstance(ac_space, spaces.MultiBinary):
        return BernoulliPdType(ac_space.n, r)
    else:
        raise NotImplementedError
